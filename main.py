...
sw_versions_updated = {'project__blackbox_exporter': {'version': '0.17.0-0.0.3', 'nvchecker_config': 'source = "github"\ngithub = "prometheus/blackbox_exporter"\nuse_latest_release = true\n'}, 'project__dellhw_exporter': {'version': '1.7.0', 'checksum': 'aaea2ce1e5efc04dcedef1145001d0d3df545eb3801c785630450db8be272768', 'nvchecker_config': 'source = "github"\ngithub = "galexrt/dellhw_exporter"\nuse_latest_release = true\n'}, 'project__dex': {'version': '2.28.1', 'nvchecker_config': 'source = "github"\ngithub = "dexidp/dex"\nuse_latest_release = true\n'}, 'project__etcd': {'version': '3.4.18', 'nvchecker_config': 'source = "github"\ngithub = "etcd-io/etcd"\nuse_max_tag = true\ninclude_regex = \'v[0-9.]+\'\n'}, 'project__gitlab': {'version': '14.8.2-ee.0', 'nvchecker_config': 'source = "gitlab"\ngitlab = "gitlab-org/gitlab"\nuse_max_tag = true\ninclude_regex = \'v[0-9.]+-ee\'\n'}, 'project__gitlab_runner': {'version': '14.8.2', 'nvchecker_config': 'source = "gitlab"\ngitlab = "gitlab-org/gitlab-runner"\nuse_max_tag = true\ninclude_regex = \'v[0-9.]+\'\n'}, 'project__harbor': {'version': '2.1.1-cps-0.7', 'nvchecker_config': 'source = "github"\ngithub = "goharbor/harbor"\nuse_max_tag = true\ninclude_regex = \'v[0-9.]+\'\n'}, 'project__harbor_exporter': {'version': '0.6.4', 'nvchecker_config': 'source = "github"\ngithub = "c4po/harbor_exporter"\nuse_latest_release = true\n'}, 'project__matchbox': {'version': '0.8.3', 'checksum': '571a6285cc27af9f1490b5829a279c9329de736ca06355ee0f23aaa8bd9da89e', 'nvchecker_config': 'source = "github"\ngithub = "poseidon/matchbox"\nuse_latest_release = true\n'}, 'project__nginx': {'version': '1.18.0', 'nvchecker_config': 'source = "container"\ncontainer = "library/nginx"\ninclude_regex = \'[0-9]+\\.[0-9]+\\.[0-9]+\'\n'}, 'project__node_exporter': {'version': '0.18.1', 'checksum': 'b2503fd932f85f4e5baf161268854bf5d22001869b84f00fd2d1f57b51b72424', 'nvchecker_config': 'source = "github"\ngithub = "prometheus/node_exporter"\nuse_latest_release = true\n'}, 'project__prometheus': {'version': '2.34.0', 'nvchecker_config': 'source = "github"\ngithub = "prometheus/prometheus"\nuse_latest_release = true\n'}, 'project__approleid_provisioner': {'version': '1.0.2', 'nvchecker_config': 'source = "gitlab"\ngitlab = "acc/approleid-provisioner"\nhost = "acc-gitlab-live.server.lan"\nuse_max_tag = true\n'}, 'project__vault': {'version': '1.9.2', 'nvchecker_config': 'source = "github"\ngithub = "hashicorp/vault"\nuse_max_tag = true\ninclude_regex = \'v[0-9.]+\'\n'}, 'project__asset_downloader': {'version': '1.3.6', 'nvchecker_config': 'source = "gitlab"\ngitlab = "acc/asset-downloader"\nhost = "acc-gitlab-live.server.lan"\nuse_max_tag = true\n'}, 'project__docker_ce': {'version': '19.03.14', 'nvchecker_config': 'source = "github"\ngithub = "docker/cli"\nuse_max_tag = true\ninclude_regex = \'v[0-9.]+\'\nfrom_pattern = \'v([0-9]+)\\.([0-9]+).*\'\nto_pattern = \'\\1.\\2\'\n'}}
